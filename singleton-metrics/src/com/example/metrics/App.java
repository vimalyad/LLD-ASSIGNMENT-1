...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("RUNNING CONCURRENCY CHECK");
        String[] arr = new String[1];
        ConcurrencyCheck.main(arr);

        System.out.println("\nRUNNING SERIALIZATION CHECK");
        SerializationCheck.main(arr);

        System.out.println("\nRUNNING REFLECTION ATTACK");
        try {
            ReflectionAttack.main(arr);
